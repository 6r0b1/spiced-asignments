(function () {
    ...
    let disclaimerContainer = document.querySelector(".disclaimer_invisible");
    let closeButton = document.querySelector(".close_disclaimer");

    setTimeout(function () {
        disclaimerContainer.classList.remove("disclaimer_invisible");
        disclaimerContainer.classList.add("disclaimer_visible");
    }, 1000);

    closeButton.addEventListener("click", function () {
        disclaimerContainer.classList.remove("disclaimer_visible");
        disclaimerContainer.classList.add("disclaimer_invisible");
    });
})();
